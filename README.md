...
A Claude Code skill for recording and transcribing meetings/calls using local transcription (Parakeet MLX).
...
```bash
npx skills add HartreeWorks/skill--transcribe-call
```
